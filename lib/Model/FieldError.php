...
class FieldError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const ERROR_CODE_DEFINED = 'DEFINED';
    public const ERROR_CODE_DUPLICATE = 'DUPLICATE';
    public const ERROR_CODE_INVALID = 'INVALID';
    public const ERROR_CODE_NOT_DEFINED = 'NOT_DEFINED';
    public const ERROR_CODE_NOT_FOUND = 'NOT_FOUND';
    public const ERROR_CODE_PLAN_TRIAL_NOT_ENABLED = 'PLAN_TRIAL_NOT_ENABLED';
    ...
    */
     ...
     * Sets path
     *
     * @param string[]|null $path The path to the faulty field, for example, `[\"user\", \"0\", \"identifier\"]`.
     *
     * @return self
     */
