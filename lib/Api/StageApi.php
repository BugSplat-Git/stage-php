...
/**
    ...
    {
        $this->createOrganizationCheckoutSessionWithHttpInfo($organization_identifier, $plan_identifier, $checkout_session_arg, $contentType);
    }
    ...
    {
        $this->createUserCheckoutSessionWithHttpInfo($user_identifier, $plan_identifier, $checkout_session_arg, $contentType);
    }
